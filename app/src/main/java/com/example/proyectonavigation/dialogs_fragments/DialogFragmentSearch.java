...
public class DialogFragmentSearch extends Fragment implements View.OnClickListener {
    ...
    public static DialogFragmentSearch newInstance(String param1, String param2) {
